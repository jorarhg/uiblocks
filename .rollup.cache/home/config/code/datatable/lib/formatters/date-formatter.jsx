...
export const DateFormatter = ({ value, field }) => {
    ...
    if (isNaN(date.getTime())) {
        return {
            content: <span className={options === null || options === void 0 ? void 0 : options.className}>{value}</span>
        };
    }
    let formattedDate;
    ...
    return {
        content: (<span className={options === null || options === void 0 ? void 0 : options.className} title={date.toLocaleString(locale)}>
        {formattedDate}
      </span>),
...
//# sourceMappingURL=date-formatter.jsx.map