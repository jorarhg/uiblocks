        ...
        <Command>
          ...
          <CommandList>
            ...
            {selectedValues.size > 0 && (<>
                <CommandSeparator />
                <CommandGroup>
                  <CommandItem onSelect={() => column === null || column === void 0 ? void 0 : column.setFilterValue(undefined)} className="justify-center text-center">
                    Clear filters
                  </CommandItem>
                </CommandGroup>
              </>)}
...
//# sourceMappingURL=data-table-faceted-filter.jsx.map