...
export const BadgeFormatter = ({ value, field, record }) => {
    ...
    return {
        content: (_jsxs(Badge, { variant: variant, className: combinedClassName, style: combinedStyle, children: [IconComponent && _jsx(IconComponent, { className: `mr-1 h-3 w-3 ${(options === null || options === void 0 ? void 0 : options.iconClassName) || ''}` }), displayText] }))
    };
};
//# sourceMappingURL=badge-formatter.js.map