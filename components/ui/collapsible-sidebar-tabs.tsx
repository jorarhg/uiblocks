 ...
 * Sidebar vertical colapsable con tabs de ícono o numéricas.
 * API enfocada en simplicidad para el consumidor final:
 * <CollapsibleSidebarTabs variant="icon" items={[{value:'home',label:'Home',icon:<Home/>}]} />
 */
